    ...
    <div className="font-sans min-h-screen flex flex-col">
      ...
      <div className="w-full relative overflow-hidden pb-3" style={{ minHeight: '320px' }}>
        ...
        <div className="relative flex flex-col items-center justify-center z-20">
          <img src={event.image} alt={event.title} className="max-w-4xl w-full rounded shadow-lg mt-4" style={{ background: '#222' }} />
      ...
      <main className="flex-1 bg-bg px-0 py-0 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4 px-4 items-center">
          ...
          {/* 收藏按鈕 */}
          <button
            className={`rounded-full border w-11 h-11 flex items-center justify-center transition
              ${isFavorited ? 'bg-red-100 border-red-400 text-red-500' : 'border-gray-300 text-gray-500 hover:bg-gray-100 hover:text-red-500'}`}
